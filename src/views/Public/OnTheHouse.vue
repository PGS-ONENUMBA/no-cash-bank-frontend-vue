              ...
              <div class="card-body">
                ...
                <div class="mb-4">
                  <div class="card text-center shadow-sm">
                    <div class="card-body">
                      <h5 class="card-title">
                        <i class="bi bi-wallet2"></i> Payment Limit
                      </h5>
                      <p class="fs-3 card-text text-success">₦100,000</p>
                      <p class="text-muted">You can process payments up to ₦100,000 per transaction.</p>
                    </div>
                  </div>
                </div>
                <p class="text-muted">
                  Use raffle tickets to pay for a client. The cash comes to the business, and any balance goes back to the customer. Follow the steps below:
                </p>
                <ul class="list-group">
                  <li class="list-group-item d-flex align-items-start">
                    <i class="bi bi-1-circle-fill text-success me-3" style="font-size: 1.5rem;"></i>
                    <div><strong>Step 1:</strong> Log in to your account and select "On The House".</div>
                  </li>
                  <li class="list-group-item d-flex align-items-start">
                  ...
                  <li class="list-group-item d-flex align-items-start">
                    ...
                    <div><strong>Step 3:</strong> Confirm the transaction, and the balance will be sent to the customer.</div>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="card-body">
                ...
                <form>
                  ...
                  <button type="submit" class="btn btn-orange custom-width mb-3">
                    <i class="bi bi-cash-coin me-2 bi-white"></i> Submit Payment Request
                  </button>
                </form>
              </div>
            </div>
